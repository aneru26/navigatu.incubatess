            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="text-align:right;">
                        <a href="{{ url('teacher/student/add')}}" class="btn btn-outline-primary">Add New Incubatees</a>
                    </div>
                                ...
                                <div class="card-body p-2">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <a href="{{ url('teacher/student/list') }}"
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item"
                                                        href="{{ url('teacher/student/show/'.$value->id) }}">Show</a>
                                                    <a class="dropdown-item"
                                                        href="{{ url('teacher/student/edit/'.$value->id) }}">Edit</a>
                                                    <a class="dropdown-item"
                                                        href="{{ url('teacher/student/delete/'.$value->id) }}">Delete</a>
                                                </div>
                                            </div>
                                        </td>
