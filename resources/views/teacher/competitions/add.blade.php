            ...
            <div class="card card-primary">
              ...
              {{ csrf_field() }}
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" value="{{ old ('competition_name') }}" name="competition_name" required placeholder="Competition Name">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="date" class="form-control" value="{{ old ('date_competition') }}" name="date_competition" required placeholder="Date of Competition">
